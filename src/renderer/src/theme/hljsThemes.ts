...
export const CODE_THEMES: { id: CodeThemeId; label: string; url: string; bg: string }[] = [
  { id: 'github',           label: 'GitHub Light',     url: githubUrl,         bg: 'rgb(248 250 252)' },
  { id: 'github-dark',      label: 'GitHub Dark',      url: githubDarkUrl,     bg: '#0d1117' },
  { id: 'atom-one-dark',    label: 'Atom One Dark',    url: atomOneDarkUrl,    bg: '#282c34' },
  { id: 'monokai',          label: 'Monokai',          url: monokaiUrl,        bg: '#272822' },
  { id: 'nord',             label: 'Nord',             url: nordUrl,           bg: '#2e3440' },
  { id: 'tokyo-night-dark', label: 'Tokyo Night Dark', url: tokyoNightDarkUrl, bg: '#1a1b26' },
  { id: 'vs2015',           label: 'VS 2015',          url: vs2015Url,         bg: '#1e1e1e' },
]
